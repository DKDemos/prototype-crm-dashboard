...
export default function Menu() {
  return (
    <div className='flex h-full w-full flex-col items-center overflow-hidden bg-gray-900 text-gray-400 shadow-lg'>
      ...
      <div className='w-full px-2'>
        <div className='mt-3 flex hidden w-full flex-col items-center border-t border-gray-700'>
          <a
          ...
          >
            ...
            >
              ...
              <path
                fill='currentColor'
                fillRule='evenodd'
                d='M12 6a1 1 0 0 0-.993.883L11 7v6a1 1 0 0 0 1.993.117L13 13V7a1 1 0 0 0-1-1m0 9a1 1 0 1 0 0 2a1 1 0 0 0 0-2'
                className='duoicon-primary-layer'
              />
            </svg>
            <span className='text-md ml-2 font-medium uppercase text-yellow-500'>
              Prototype
            </span>
          </a>
        </div>
